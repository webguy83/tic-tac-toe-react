    ...
    <div className='main-menu'>
      ...
      <div className='picker'>
        ...
        <div className='options'>
          <button
            type='button'
            className={`option ${playerChoice === 'X' ? 'selected' : ''}`}
          ...
          <button
            type='button'
            className={`option ${playerChoice === 'O' ? 'selected' : ''}`}
      ...
      <button
        ...
        onClick={() => startGame('cpu', playerChoice)}
      >
        New Game (VS CPU)
      </button>
      <button
        ...
        onClick={() => startGame('player', playerChoice)}
      >
        New Game (VS Player)
      </button>
    </div>
